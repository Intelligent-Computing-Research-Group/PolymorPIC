...
class PTW_query(implicit p: Parameters) extends LazyModule
{
    val mm_addr=MMIO.query_tlb_MMIO_bigInt
    ...
    {  
        ...
        val vaddr_reg = RegInit(0.U(64.W))
        ...
        // tlb_slave_tl.d.bits.data := req_addr
