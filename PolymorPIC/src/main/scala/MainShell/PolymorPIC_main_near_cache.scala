...
class PolymorPIC_main_near_cache(sysCfg:Sys_Config,core_configs:PolymorPIC_Kernal_Config)(implicit p: Parameters) extends LazyModule
{
    // DMA reader&writer
    ...
    class Sys_main_impl extends LazyModuleImp(this) 
    {
        ...
        // IO for SwitchCtl (mainly for testing)
